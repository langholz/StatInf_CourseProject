...
2. For the test with the 2.0 mg dose, the 95% confidence intervals lower and upper bound (`r as.character(round(suppByDoseConfInts[1, 3], 5))`, `r as.character(round(suppByDoseConfInts[2, 3], 5))`) touches zero. This is an indication that the influence of either is inconclusive.
